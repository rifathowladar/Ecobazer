...
import review1 from '../../assets/image/review1.webp'
import review2 from '../../assets/image/review2.webp'
import review3 from '../../assets/image/review3.webp'
                ...
                <SwiperSlide>
                    <div className="bg-white w-100 p-6 rounded-lg">
                        ...
                        <div className="py-4 pr-4">
                            <p className="text-sm text-gray-700">Pellentesque eu nibh eget mauris congue mattis mattis nec tellus. Phasellus imperdiet elit eu magna dictum, bibendum cursus velit sodales. Donec sed neque eget</p>
                        </div>
