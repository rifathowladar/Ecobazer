            ...
            <div className="flex flex-col md:flex-row justify-between gap-6 md:gap-8">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-0">
                    <div className="relative w-full lg:w-auto">
                        <input className='border bg-white border-[#E5E5E5] sm:border-r-0 w-full lg:w-96 py-2.5 sm:py-3 pl-9 sm:pl-11 placeholder:text-[#808080] placeholder:text-xs sm:placeholder:text-sm sm:rounded-tl-full sm:rounded-bl-full outline-none rounded-full' type='text' placeholder='Your email address'/>
                        <IoIosMail className="absolute top-0 translate-y-1/2 left-3 sm:left-4 text-[#808080] text-xl sm:text-2xl"/>
                        <button className="font-semibold mt-5 sm:mt-0 text-xs sm:text-sm bg-primary text-white px-6 sm:px-10 py-3 sm:py-4 relative top-0 sm:top-[-2px] left-0 sm:left-[-45px] rounded-full w-full sm:w-auto">Subscribe</button>
                    </div>
