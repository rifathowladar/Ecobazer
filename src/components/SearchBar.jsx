...
const SearchBar = () => {
  return (
    <div className="border-b border-solid border-b-gry">
        <Container>
            <div className="flex flex-col md:flex-row lg:flex-row justify-between items-center gap-4 my-4 md:my-5 lg:my-6">
                <Link to="/">
                    <img src={Logo} alt='logo' fetchPriority='high' loading="lazy" className="max-w-[120px] md:max-w-full"/>
                </Link>
                ...
                <div className="flex gap-x-3 md:gap-x-4 lg:gap-x-8">
                    ...
                    <div className="flex gap-2 md:gap-3 items-center">
                        <div className="">
                            <SlHandbag className="text-[24px] md:text-[28px] lg:text-[34px]"/>
                        </div>
