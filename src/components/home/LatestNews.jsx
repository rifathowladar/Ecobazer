...
const LatestNews = () => {
  return (
    <Container>
        <div className="">
            <h3 className="font-semibold text-xl sm:text-hsize text-center">Latest News</h3>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 my-5 sm:my-15">
            <div className="shadow-md rounded hover:scale-102 transition duration-300 group">
                ...
                <div className="m-6">
                    ...
                    <h4 className="text-sm sm:text-lg text-gray-900 group-hover:text-primary pr-10 pt-2">
                        Curabitur porttitor orci eget neque accumsan venenatis. Nunc fermentum.
                    </h4>
                    <Link to="#">
                        <h5 className="flex gap-2 text-primary pt-5 text-sm sm:text-lg items-center">Read More<FaArrowRight/></h5>
                    </Link>
                </div>
            </div>
            <div className="shadow-md rounded hover:scale-102 transition duration-300 group">
